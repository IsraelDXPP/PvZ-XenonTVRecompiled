...
enum KeyCode {
    ...
    //
    KEYCODE_QUICK_DIG = 0x31, // QuickDigKeyCodeDown
    KEYCODE_X_BUTTON = 0x32,  // XButtonKeyCodeDown
    KEYCODE_X2_BUTTON = 0x33, // X2ButtonKeyCodeDown
    //
    ...
    KEYCODE_GAMEPAD_TL2,
    KEYCODE_GAMEPAD_TR2,
    KEYCODE_GAMEPAD_SELECT,
    KEYCODE_GAMEPAD_START,
    KEYCODE_GAMEPAD_MODE,
    KEYCODE_GAMEPAD_THUMBL,
    KEYCODE_GAMEPAD_THUMBR,
    KEYCODE_GAMEPAD_LEFT = 0x230,
    KEYCODE_GAMEPAD_UP,
    KEYCODE_GAMEPAD_RIGHT,
    KEYCODE_GAMEPAD_DOWN,
